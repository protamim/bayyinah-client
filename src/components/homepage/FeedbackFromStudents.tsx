          ...
          <div aria-describedby="main-wrapper">
            ...
            >
              <div
                ...
                className="flex items-center h-[414px] gap-x-3"
              >
                <Image
              ...
              <div
                ...
                className="absolute right-24 -top-12 z-20"
              >
                <Carousel
                  className="w-[480px] shadow-lg rounded-2xl"
                ...
                >
                    ...
                    {Array.from({ length: 10 }).map((_, index) => (
                      <CarouselItem key={index}>
                        <div
                          ...
                          className="bg-white p-9 rounded-2xl border border-[#EDEDED] flex flex-col items-start gap-y-9"
                        >
                          <div
                  ...
                  <div
                    ...
                    className="absolute top-full w-2xs translate-y-16 left-1/2 -translate-x-1/2 z-40 flex items-center gap-x-3"
                  >
